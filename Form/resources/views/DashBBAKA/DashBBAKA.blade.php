...
@include('DashBBAKA.navbar')
          ...
          <div class="col-12 col-md-4 d-flex align-items-stretch flex-column">
            <div class="card bg-secondary text-white d-flex align-items-center p-2">
              <div class="card-body text-center">
                ...
                <p class="mb-1"><strong>{{ $baka->nama }}</strong></p>
                <p class="mb-1">{{ $baka->nip }}</p>
                <p class="text-muted">{{ $baka->email }}</p>
  ...
  <!-- Control Sidebar -->
  @include('DashBBAKA.controllersidebar')
  <!-- /.control-sidebar -->
