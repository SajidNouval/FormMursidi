...
<head>
  ...
  <title>SAKURA | Konsultasi</title>
  @include('HerRegMHS.headerkonsul')
  <style>
...
@include('DashBMHS.navbar')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="{{ route('konsulcompose') }}" class="btn btn-primary btn-block mb-3">Compose</a>
...
<!-- REQUIRED SCRIPTS -->
@include('HerRegMHS.scriptkonsul')
</body>
</html>
